...
class TrackerDetail(PermissionRequiredMixin, TemplateView):
...
class TrackerAdd(PermissionRequiredMixin, LoginRequiredMixin, CreateView):
...
class TrackerUpdateView(PermissionRequiredMixin, LoginRequiredMixin, UpdateView):
    model = Tracker
...
class DeleteTrackerView(PermissionRequiredMixin, LoginRequiredMixin, DeleteView):
...
class ProjectView(PermissionRequiredMixin, LoginRequiredMixin, ListView):
...
class ProjectAdd(PermissionRequiredMixin, LoginRequiredMixin, CreateView):
